...
class _WaAppBarState extends State<WaAppBar>
  ...
  void initState() {
    super.initState();
    _tabController = TabController(vsync: this, initialIndex: TabIndex.CHATS.index, length: _tabs.length);
    _tabController.addListener(() { 
      Provider.of<SwitchTabsModel>(context, listen: false).updateTabIndex(TabIndex.values[_tabController.index]);
     });
  }
